...
public class IniciadorConversionMonedas {
    ...
    private static final String PESO_MEXICANO_PARA_REAL = "De Peso Mexicano a Real";
    ...
    public BigDecimal operarConversao(String operacionMonedas, double valorInicial) throws Exception {
        ...
        switch (operacionMonedas) {
            ...
            case PESO_MEXICANO_PARA_REAL -> {
            	return convertidorDeMonedaPesoMexicano.convertirParaReal(moneda, BigDecimal.valueOf(valorInicial));
            }
